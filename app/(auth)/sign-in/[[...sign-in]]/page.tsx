...
export default function SignInPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] relative overflow-hidden py-12 px-4 sm:px-6 lg:px-8">
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(45rem_50rem_at_center,theme(colors.indigo.100),theme(colors.transparent))] dark:bg-[radial-gradient(45rem_50rem_at_center,theme(colors.indigo.900),theme(colors.transparent))] opacity-50" />
      ...
      <div className="w-full max-w-md space-y-8 animate-in fade-in zoom-in-95 duration-700">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
            Sign in to continue exploring and saving your favorite movies.
          </p>
        </div>
