  ...
  return (
    <div className="flex min-h-[calc(100vh-4rem)] bg-white dark:bg-[#0a0a0a]">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-black items-center justify-center">
        ...
        <div className="absolute inset-0 bg-purple-900/20 mix-blend-multiply z-10" />
        <Image 
        ...
        <div className="relative z-20 p-12 text-center animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300 fill-mode-both">
          <h2 className="text-4xl xl:text-5xl font-extrabold text-white mb-6 tracking-tight drop-shadow-lg leading-tight">
            Start Your <br />
            <span className="text-purple-400">Cinematic Journey</span>
          </h2>
          <p className="text-lg text-gray-300 max-w-md mx-auto leading-relaxed">
            Create an account to build your ultimate movie collection and never forget a great film.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 sm:p-12 lg:p-16 relative">
         <div className="absolute inset-0 lg:hidden -z-10 bg-[radial-gradient(45rem_50rem_at_center,theme(colors.purple.50),theme(colors.transparent))] dark:bg-[radial-gradient(45rem_50rem_at_center,theme(colors.purple.900),theme(colors.transparent))] opacity-50" />
        ...
        <div className="w-full max-w-md space-y-8 animate-in fade-in zoom-in-95 duration-700">
          ...
          <div className="bg-white dark:bg-zinc-900/80 backdrop-blur-xl p-8 sm:p-10 rounded-[2rem] shadow-2xl shadow-purple-500/5 dark:shadow-none border border-gray-100 dark:border-zinc-800">
            <SignUp 
              path="/sign-up" 
              routing="path" 
              signInUrl="/sign-in"
              appearance={{
                elements: {
                  ...
                  formFieldInput: "bg-gray-50 dark:bg-zinc-950/50 border-gray-200 dark:border-zinc-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all rounded-xl",
                  formButtonPrimary: "bg-purple-600 hover:bg-purple-700 text-white transition-colors border-0 shadow-md shadow-purple-500/20 rounded-xl h-10 font-medium",
                  footerActionText: "text-gray-500 dark:text-gray-400",
                  footerActionLink: "text-purple-600 dark:text-purple-400 hover:text-purple-500 font-semibold transition-colors",
